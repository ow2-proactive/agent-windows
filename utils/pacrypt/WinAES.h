...
#define DllExport  __declspec( dllexport )
	...
	/**
	 * Encrypts a data using Microsoft AES Cryptographic Service Provider
	 * and a 128 bits key.
	 *
	 * @param inputData string to encrypt
	 ...
	 * and a 128 bits key.
	 *
	 * @param inputDataInHex encrypted data in hex format
...
extern "C" {
	 ...
	 * and a 128 bits key.
	 *
	 * @param inputData cstring to encrypt
	 * @param outputDataInHex encrypted data in hex format
	 * @return 0 if no errors
	 */
